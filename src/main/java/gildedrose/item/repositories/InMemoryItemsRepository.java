...
public class InMemoryItemsRepository implements ItemGateway {
    ...
    public InMemoryItemsRepository() {
        items.add(new GenericItem("Generic", 5, 8, 10, 1, 0));
        items.add(new GenericItem("Generic", 0, 8, 10, 1, 0));
        items.add(new GenericItem("Generic", 5, 0, 10, 1, 0));
        items.add(new AggingItem("Aged Brie", 5, 5, 10));
        items.add(new AggingItem("Aged Brie", 5, 50, 10));
        items.add(new LegendaryItem("Sulfuras", 80, 10, 1, 0));
